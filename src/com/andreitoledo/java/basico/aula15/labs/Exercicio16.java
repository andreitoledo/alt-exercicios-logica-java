...
public class Exercicio16 {
	 ...
	 * forma ax2 + bx + c. O programa deverá pedir os valores de a, b e c e
	 ...
	 * encerrado; b. Se o delta calculado for negativo, a equação não possui
	 * raizes reais. Informe ao usuário e encerre o programa; c. Se o delta
	 * calculado for igual a zero a equação possui apenas uma raiz real;
