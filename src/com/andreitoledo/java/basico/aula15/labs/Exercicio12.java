...
public class Exercicio12 {
	...
	public static void main(String[] args) {
		 ...
		 * que deposita). O Salário Líquido corresponde ao Salário Bruto menos
		 * os descontos. O programa deverá pedir ao usuário o valor da sua hora
		 ...
		 * até 2500 (inclusive) - desconto de 10% - Salário Bruto acima de 2500
		 * - desconto de 20%
		 * 
		 * Imprima na tela as informações, dispostas conforme o exemplo abaixo.
		 * No exemplo o valor da hora é 5 e a quantidade de hora é 220.
		 * 
		 * Salário Bruto: (5 * 220) : R$ 1100,00 (-) IR (5%) : R$ 55,00 (-) INSS
		 * ( 10%) : R$ 110,00 FGTS (11%) : R$ 121,00 Total de descontos : R$
		 * 165,00 Salário Liquido : R$ 935,00
		 */
		...
		System.out.println("Salario Bruto: (5 * 220) " + " : R$ " + salarioBruto);
